                ...
                echo "<tr class='groupItem'>
                    ...
                    <td>
                        <form method='post'>
                            ...
                            <button name='deleteGroup' class='w3-button w3-red' type='submit'>
                                Usuń
                            </button>
                        </form>
                    </td>
...
<div>
    <h1>Pytania</h1>
    <input class="w3-input w3-border w3-padding" type="text" placeholder="Filtruj pytania.." onkeyup='w3.filterHTML("q#uestionsTable", ".guestionItem", this.value)'>
