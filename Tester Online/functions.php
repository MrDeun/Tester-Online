...
function checkSessionAndRedirect($sessionVar, $levelsUp) {
...
function generateForm($action, $buttonName, $formClass = "w3-left") {
    echo "<form class='w3-container $formClass' action='$action' method='POST'>";
