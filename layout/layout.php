...
<head>
    ...
    <?php
        ...
        switch ($site_address) {
            case "questions.php":
                echo "<script src='$path/wwwroot/js/questions.js'></script>";
                break;
            case "questions_create.php":
                echo "<script src='$path/wwwroot/js/question_create.js'></script>";
                break;
            case "test_template.php":
                echo "<script src='$path/wwwroot/js/template.js'></script>";
                break;
            case "test_template_create.php":
                echo "<script src='$path/wwwroot/js/template_create.js'></script>";
                break;               
            default:
                # code...
                break;
